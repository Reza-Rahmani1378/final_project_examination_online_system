...
<div class="container text-center" align="center">
    ...
    <c:url value="/student/studentCourses" var="pagedLink">
    ...
    <div class="text-center">
        ...
        <table class="table text-center table-bordered table-striped">
            ...
            <tr>
                <th colspan="5" style="text-align: center">Available Courses</th>
            </tr>
            </thead>
            ...
            <c:forEach items="${pagedListHolder.pageList}" var="course">
                <tr>
                    <td>${course.id}</td>
                    <td>${course.titleCourse}</td>
                    <td>${course.startCourse}</td>
                    <td>${course.endCourse}</td>
                    <td><a href=studentExams?courseId=${course.id}>View Exams Course</a></td>
                </tr>
            </c:forEach>
            </tbody>
