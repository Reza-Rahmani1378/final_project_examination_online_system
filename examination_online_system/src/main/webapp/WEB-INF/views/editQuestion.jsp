...
<div class="container text-center">
    ...
    <div id="descriptive">
        <form action="/professor/confirmEditQuestionDescriptive" method="post"
            ...
            <div class="m-3">
                ...
                <div class="form-group row">
                    <label class="col-4 col-form-label">Question Score </label>
                    <div class="col-8">
                        <input class="form-control" type="number" min="1" name="questionScore"/>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <button class="btn-dark" type="submit">Edit Question</button>
                </div>
            </div>
        </form>
        ...
        <div class="row clearfix">
            <div class="col-md-12 table-responsive">
                <div class="container text-center">
                    ...
                    <form action="/professor/confirmEditQuestionOptional" method="post"
                          style="max-width: 600px; margin: 0 auto;">
                        <div class="m-3">
                            <div class="form-group row">
                                <label class="col-4 col-form-label">Question Title </label>
                            ...
                            <div>
                                ...
                                <button name="addQuestion" class="btn-dark" type="submit">Edit Question</button>
                            </div>
                        </div>
